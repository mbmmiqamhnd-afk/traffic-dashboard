...
DEFAULT_PTL = pd.DataFrame([
    {"編組": "", "無線電代號": "", "單位": "聖亭所", "職別": "副所長", "姓名": "邱品淳", "任務分工": "帶班",      "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "中正路、北龍路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "聖亭所", "職別": "警員",   "姓名": "劉憬霖", "任務分工": "攔檢盤查",  "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "中正路、北龍路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "聖亭所", "職別": "警員",   "姓名": "謝伯昇", "任務分工": "警戒兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "中正路、北龍路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "龍潭所", "職別": "警員",   "姓名": "張家維", "任務分工": "帶班兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "北龍路、中豐路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "龍潭所", "職別": "警員",   "姓名": "王采蘋", "任務分工": "攔檢盤查",  "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "北龍路、中豐路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "中興所", "職別": "所長",   "姓名": "董亦文", "任務分工": "帶班兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "東龍路、中豐路沿線機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "中興所", "職別": "警員",   "姓名": "羅俊傑", "任務分工": "攔檢盤查",  "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "東龍路、中豐路沿線機動攔查。(20:00-21:30機動，後轉臨慢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "石門所", "職別": "所長",   "姓名": "林育辰", "任務分工": "帶班兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "神龍路、文化路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "三和所", "職別": "警員",   "姓名": "童霈晟", "任務分工": "攔檢盤查",  "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "神龍路、文化路周邊及治安要點機動攔查。(20:00-21:30機動，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "石門所", "職別": "巡佐",   "姓名": "林偉政", "任務分工": "帶班兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "中興路、龍新路沿線及治安要點機動攔查。(全程留守機動 20:00-23:00) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "高平所", "職別": "警員",   "姓名": "葉雲翔", "任務分工": "攔檢盤查",  "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "中興路、龍新路沿線及治安要點機動攔查。(全程留守機動 20:00-23:00) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "龍潭交分隊", "職別": "警員", "姓名": "林家豪", "任務分工": "帶班兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "轄內易發生危駕路段、各聯外道路機動攔查。(全程留守機動 20:00-23:00) *雨天備案:轄區治安要點巡邏。"},
    {"編組": "", "無線電代號": "", "單位": "龍潭交分隊", "職別": "警員", "姓名": "吳沛軒", "任務分工": "攔檢盤查",  "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "轄內易發生危駕路段、各聯外道路機動攔查。(全程留守機動 20:00-23:00) *雨天備案:轄區治安要點巡邏。"},
])

DEFAULT_CHECKPOINT = pd.DataFrame([
    {"編組": "", "無線電代號": "", "單位": "中興所", "職別": "所長",   "姓名": "董亦文", "任務分工": "帶班",           "臨檢目標場所": "A. 鉅大撞球館 (中豐路558號)\nB. 台灣麻將協會 (中豐路558之1號)\nC. 丹陽泰養生館 (中豐路281號)\nD. 溫馨汽車旅館 (中正路457號)\nE. 凱虹汽車旅館 (中正路506號)\n*(各員均需著防彈衣，攜帶槍彈、小電腦、密錄器)*"},
    {"編組": "", "無線電代號": "", "單位": "中興所", "職別": "警員",   "姓名": "羅俊傑", "任務分工": "製作臨檢紀錄",    "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、C. 丹陽泰養生館、D. 溫馨汽車旅館、E. 凱虹汽車旅館"},
    {"編組": "", "無線電代號": "", "單位": "龍潭所", "職別": "警員",   "姓名": "張家維", "任務分工": "盤查兼蒐證",     "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、C. 丹陽泰養生館、D. 溫馨汽車旅館、E. 凱虹汽車旅館"},
    {"編組": "", "無線電代號": "", "單位": "龍潭所", "職別": "警員",   "姓名": "王采蘋", "任務分工": "盤查兼蒐證",     "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、C. 丹陽泰養生館、D. 溫馨汽車旅館、E. 凱虹汽車旅館"},
    {"編組": "", "無線電代號": "", "單位": "偵查隊", "職別": "警員",   "姓名": "許家洋", "任務分工": "刑案偵防、社維法案件查處", "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、C. 丹陽泰養生館、D. 溫馨汽車旅館、E. 凱虹汽車旅館"},
    {"編組": "", "無線電代號": "", "單位": "石門所", "職別": "所長",   "姓名": "林育辰", "任務分工": "帶班",           "臨檢目標場所": "A. 鉅大撞球館 (中豐路558號)\nB. 台灣麻將協會 (中豐路558之1號)\nF. 憤怒鳥網咖\nG. 真情男女養生館\nH. 萬紫千紅舒壓館\n*(各員均需著防彈衣，攜帶槍彈、小電腦、密錄器)*"},
    {"編組": "", "無線電代號": "", "單位": "聖亭所", "職別": "副所長", "姓名": "邱品淳", "任務分工": "製作臨檢紀錄",    "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、F. 憤怒鳥網咖、G. 真情男女養生館、H. 萬紫千紅舒壓館"},
    {"編組": "", "無線電代號": "", "單位": "聖亭所", "職別": "警員",   "姓名": "劉憬霖", "任務分工": "盤查兼蒐證",     "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、F. 憤怒鳥網咖、G. 真情男女養生館、H. 萬紫千紅舒壓館"},
    {"編組": "", "無線電代號": "", "單位": "三和所", "職別": "警員",   "姓名": "謝伯昇", "任務分工": "大門警戒",       "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、F. 憤怒鳥網咖、G. 真情男女養生館、H. 萬紫千紅舒壓館"},
    {"編組": "", "無線電代號": "", "單位": "偵查隊", "職別": "小隊長", "姓名": "陳正育", "任務分工": "刑案偵防、社維法案件查處", "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、F. 憤怒鳥網咖、G. 真情男女養生館、H. 萬紫千紅舒壓館"},
    {"編組": "", "無線電代號": "", "單位": "偵查隊", "職別": "偵查佐", "姓名": "鄧正斌", "任務分工": "持DV全程蒐證",   "臨檢目標場所": "A. 鉅大撞球館、B. 台灣麻將協會、F. 憤怒鳥網咖、G. 真情男女養生館、H. 萬紫千紅舒壓館"},
])
...
# ══════════════════════════════════════════════════════════════════════════════
# 3. 分組與同步邏輯 (修正：允許跨單位共用編組，並加入自動同步轉換機制)
# ══════════════════════════════════════════════════════════════════════════════
...
def sync_ptl_to_cp_logic(df_ptl: pd.DataFrame) -> pd.DataFrame:
    """將第一階段名冊自動抓取轉換，對應帶入第二階段的映射函數"""
    if df_ptl.empty:
        return pd.DataFrame(columns=["編組", "無線電代號", "單位", "職別", "姓名", "任務分工", "臨檢目標場所"])
...
def save_data(unit, time_str, project, briefing,
    ...
    try:
        ...
        for ws_name, df in [("三合一_指揮組", df_cmd),
            ...
            # 修正：移除原本會把「編組」捨棄的程式碼，確保自訂跨單位編組可以完美留存於 Google 試算表
            if not clean.empty:
...
with tab2:
    # ── 新增功能：一鍵自第一階段自動映射名冊按鈕 ──────────────────────
    col_sync, _ = st.columns([1, 3])
    with col_sync:
        if st.button("🔄 帶入第一階段服勤名冊", use_container_width=True, help="清除現有第二階段資料，並由第一階段人員自動對應帶入"):
            if not st.session_state.df_ptl.empty:
                # 呼叫同步映射邏輯
                synced_cp = sync_ptl_to_cp_logic(st.session_state.df_ptl)
                
                # 自動填充預設目標場所臨檢點（第1臨檢組對應中興所範本，第2臨檢組對應石門所範本）
                ...
                st.success("✅ 已成功自動抓取第一階段名冊並完成跨單位映射分組！")
                st.rerun()
            else:
