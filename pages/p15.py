...
# 肆、第一階段機動攔查底稿（無線電呼號欄位改由智能算法產生，並允許網頁手改）
DEFAULT_PTL = pd.DataFrame([
    ...
    {"單位": "聖亭所", "無線電代號": "", "職別": "警員", "姓名": "謝伯昇", "任務分工": "警戒兼蒐證", "攜行裝備": "槍彈、無線電、小電腦、密錄器", "巡邏路段": "中正路、北龍路周邊及治安要點機動攔查。(20:00-21:30機动，後轉臨檢) *雨天備案:轄區治安要點巡邏。"},
...
# 【核心演算法更新】依據警政無線電規則自動產出個人的初始無線電代號呼號
...
def generate_pdf_from_data(unit, project, time_str, briefing, df_cmd, df_ptl, df_cp, stats, ptl_f, cp_f):
    ...
    # 肆、【核心修正】第一階段機動攔查（全組無線電代號自動對齊首列人員）
    ...
    # 伍、【核心修正】第二階段擴大臨檢（全組無線電代號自動對齊首列人員）
