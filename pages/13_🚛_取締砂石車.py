...
def generate_pdf(month, briefing, df_cmd, df_schedule):
    ...
    data2.append([Paragraph(f"<b>{h}</b>", s_th) for h in ["日期", "執行單位", "執行人數", "執行路段"]])
...
def get_html():
    ...
    parts.append("<tr><th width='28%'>日期</th><th width='16%'>執行單位</th><th width='12%'>執行人數</th><th width='44%'>執行路段</th></tr>")
