...
# ★ 保留法令宣導於底層常數，供 PDF 生成使用，網頁不再顯示輸入框
...
def load_data():
    try:
        ...
        try:
            ws_cmd = sh.worksheet(cmd_ws_name)
...
# ★ 修正點：移除網頁上的大文字區塊（st.text_area("陸、 工作重點與法令宣導") 欄位已被完全移除）
