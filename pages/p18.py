...
def p18_page():
    ...
    st.markdown(f"**共同作業名單 (已根據最新分工規則更新預設值)**")
    ...
    default_coworkers_data = [
        ...
        {"分配類別": "勤務督導(20%)", "單位": "秘書室", "職別": "巡官", "姓名": "陳鵬翔", "設定數值": 64, "蓋章": ""},
        ...
        {"分配類別": "勤務督導(20%)", "單位": "保安民防組", "職別": "組長", "姓名": "蔡奇青", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "保安民防組", "職別": "警務員", "姓名": "曾盛鉉", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "保安民防組", "職別": "巡官", "姓名": "李立人", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "保安民防組", "職別": "巡官", "姓名": "林沛達", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "保安民防組", "職別": "巡官", "姓名": "吳國棟", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "行政組", "職別": "組長", "姓名": "周金柱", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "行政組", "職別": "巡官", "姓名": "蕭凱文", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "防治組", "職別": "組長", "姓名": "沈鳳漳", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "防治組", "職別": "巡官", "姓名": "陳冠亘", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "聖亭派出所", "職別": "所長", "姓名": "鄭榮捷", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "聖亭派出所", "職別": "副所長", "姓名": "邱品淳", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "聖亭派出所", "職別": "副所長", "姓名": "曹培翔", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "聖亭派出所", "職別": "業務承辦人", "姓名": "曾建凱", "設定數值": 90, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭派出所", "職別": "所長", "姓名": "孫祥愷", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭派出所", "職別": "副所長", "姓名": "劉重言", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭派出所", "職別": "副所長", "姓名": "梁順安", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭派出所", "職別": "業務承辦人", "姓名": "周薇", "設定數值": 90, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "中興派出所", "職別": "所長", "姓名": "董亦文", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "中興派出所", "職別": "副所長", "姓名": "何昀融", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "中興派出所", "職別": "副所長", "姓名": "林榮裕", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "中興派出所", "職別": "業務承辦人", "姓名": "鄧雅文", "設定數值": 90, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "石門派出所", "職別": "所長", "姓名": "林育辰", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "石門派出所", "職別": "副所長", "姓名": "薛德祥", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "石門派出所", "職別": "業務承辦人", "姓名": "陳琦", "設定數值": 89, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "高平派出所", "職別": "所長", "姓名": "王梓岳", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "高平派出所", "職別": "副所長", "姓名": "楊勝吉", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "高平派出所", "職別": "業務承辦人", "姓名": "黃丞潁", "設定數值": 89, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "三和派出所", "職別": "所長", "姓名": "宋開國", "設定數值": 194, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "三和派出所", "職別": "副所長", "姓名": "陳佶汎", "設定數值": 194, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "三和派出所", "職別": "業務承辦人", "姓名": "童霂晟", "設定數值": 89, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭交通分隊", "職別": "分隊長", "姓名": "卓宜澂", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭交通分隊", "職別": "小隊長", "姓名": "鄭敬思", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭交通分隊", "職別": "小隊長", "姓名": "蔡安龍", "設定數值": 195, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "龍潭交通分隊", "職別": "業務承辦人", "姓名": "陳建穎", "設定數值": 89, "蓋章": ""}
    ]
