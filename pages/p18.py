...
def p18_page():
    ...
    default_coworkers_data = [
        ...
        {"分配類別": "負責管考(72%)", "單位": "會計室", "職別": "主計", "姓名": "郭貞彣", "設定數值": 77, "蓋章": ""},
        {"分配類別": "負責管考(72%)", "單位": "會計室", "職別": "主計", "姓名": "林玲宜", "設定數值": 78, "蓋章": ""},
        ...
        {"分配類別": "其他配合(8%)", "單位": "聖亭派出所", "職別": "所長", "姓名": "鄭榮捷", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "聖亭派出所", "職別": "副所長", "姓名": "邱品淳", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "聖亭派出所", "職別": "副所長", "姓名": "曹培翔", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "聖亭派出所", "職別": "業務承辦人", "姓名": "曾建凱", "設定數值": 90, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭派出所", "職別": "所長", "姓名": "孫祥愷", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭派出所", "職別": "副所長", "姓名": "劉重言", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭派出所", "職別": "副所長", "姓名": "梁順安", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭派出所", "職別": "業務承辦人", "姓名": "周薇", "設定數值": 90, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "中興派出所", "職別": "所長", "姓名": "董亦文", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "中興派出所", "職別": "副所長", "姓名": "何昀融", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "中興派出所", "職別": "副所長", "姓名": "林榮裕", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "中興派出所", "職別": "業務承辦人", "姓名": "鄧雅文", "設定數值": 90, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "石門派出所", "職別": "所長", "姓名": "林育辰", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "石門派出所", "職別": "副所長", "姓名": "薛德祥", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "石門派出所", "職別": "業務承辦人", "姓名": "陳琦", "設定數值": 89, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "高平派出所", "職別": "所長", "姓名": "王梓岳", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "高平派出所", "職別": "副所長", "姓名": "楊勝吉", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "高平派出所", "職別": "業務承辦人", "姓名": "黃丞潁", "設定數值": 89, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "三和派出所", "職別": "所長", "姓名": "宋開國", "設定數值": 194, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "三和派出所", "職別": "副所長", "姓名": "陳佶汎", "設定數值": 194, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "三和派出所", "職別": "業務承辦人", "姓名": "童霂晟", "設定數值": 89, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭交通分隊", "職別": "分隊長", "姓名": "卓宜澂", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭交通分隊", "職別": "小隊長", "姓名": "鄭敬思", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭交通分隊", "職別": "小隊長", "姓名": "蔡安龍", "設定數值": 195, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "龍潭交通分隊", "職別": "業務承辦人", "姓名": "陳建穎", "設定數值": 89, "蓋章": ""},
        ...
        {"分配類別": "勤務督導(20%)", "單位": "勤務中心", "職別": "警員", "姓名": "王天龍", "設定數值": 65, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "勤務中心", "職別": "警員", "姓名": "曾嘉偉", "設定數值": 65, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "勤務中心", "職別": "警員", "姓名": "江文頌", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "秘書室", "職別": "巡官", "姓名": "陳鵬翔", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "督察組", "職別": "組長", "姓名": "賴永益", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "督察組", "職別": "督察員", "姓名": "黃中彥", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "督察組", "職別": "警務員", "姓名": "陳冠彰", "設定數值": 64, "蓋章": ""},
        {"分配類別": "勤務督導(20%)", "單位": "督察組", "職別": "巡官", "姓名": "全楚文", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "保安民防組", "職別": "組長", "姓名": "蔡奇青", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "保安民防組", "職別": "警務員", "姓名": "曾盛鉉", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "保安民防組", "職別": "巡官", "姓名": "李立人", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "保安民防組", "職別": "巡官", "姓名": "林沛達", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "保安民防組", "職別": "巡官", "姓名": "吳國棟", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "行政組", "職別": "組長", "姓名": "周金柱", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "行政組", "職別": "巡官", "姓名": "蕭凱文", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "防治組", "職別": "組長", "姓名": "沈鳳漳", "設定數值": 64, "蓋章": ""},
        {"分配類別": "其他配合(8%)", "單位": "防治組", "職別": "巡官", "姓名": "陳冠亘", "設定數值": 64, "蓋章": ""}
    ]
    ...
    edited_df_coworkers = st.data_editor(
        ...
        column_config={
            ...
            "設定數值": st.column_config.NumberColumn(col_name_display, min_value=0, step=1, format="%d")
        }
    )
        ...
        with st.spinner("正在計算點數與分派各類獎金..."):
            try:
                ...
                if "系統自動" in alloc_mode:
                    ...
                    df_coworkers_work['金額'] = 0
                    
                    # 針對每一類別根據「權重基數」進行分配
                    for cat, pool in [("負責管考(72%)", pool_72), ("勤務督導(20%)", pool_20), ("其他配合(8%)", pool_08)]:
                        cat_mask = df_coworkers_work['分配類別'] == cat
                        sum_w = df_coworkers_work.loc[cat_mask, '設定數值'].sum()
                        
                        if sum_w > 0 and pool > 0:
                            # 依比例分配
                            amounts = np.round((df_coworkers_work.loc[cat_mask, '設定數值'] / sum_w) * pool).astype(int)
                            # 修正四捨五入造成的微小誤差 (將零頭補給基數最大的人)
                            diff = pool - amounts.sum()
                            if diff != 0:
                                idx_max = df_coworkers_work.loc[cat_mask, '設定數值'].idxmax()
                                amounts.at[idx_max] += diff
                            df_coworkers_work.loc[cat_mask, '金額'] = amounts
                            
                    df_coworkers_output = df_coworkers_work.drop(columns=['設定數值'])
                else:
                    # 手動模式：直接把輸入的數值當作金額
                    df_coworkers_output = df_coworkers_work.rename(columns={'設定數值': '金額'})
                ...
                if ok:
                    st.success(f"✅ 雙報表產出成功！已自動處理 72/20/8 獎金比例，檔案已夾帶備份至您的信箱。")
                else:
