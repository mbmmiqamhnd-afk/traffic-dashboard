...
def show_sidebar():
    with st.sidebar:
        ...
        # ✅ 將原來的 "PDF 轉 PPTX 工具" 重新命名為 "綜合檔案轉檔工具"
        st.page_link("pages/p06.py", label="綜合檔案轉檔工具", icon="🗂️")
...
def main():
    ...
    ✅ **最新系統更新：**
    * 已於「輔助工具」專區將 PDF 工具升級為 **[綜合檔案轉檔工具]**，全新支援「PDF 轉 PPTX」、「PDF 轉圖片」以及「多張圖片合併為單一 PDF」功能。
